...
class MaxNeighborhood:
    ...
    def max_neighborhood_centrality(self, feature_option):
      ...
      if 'edge_weight' not in df.columns:
             ...
             if G.edges():  # Check if the graph has any edges
              max_neighborhood_centrality = ncl.mnc_centrality(G)
              edge_labels=None
      ...
      viz(G, max_neighborhood_centrality, edge_labels)
      return max_neighborhood_centrality
    

       
    def max_neighborhood_whole(self, feature_option):
      ...
      if 'edge_weight' not in df.columns:
        ...
        G.remove_edges_from(nx.selfloop_edges(G))
        if G.edges():  # Check if the graph has any edges
             max_neighborhood_whole = ncl.mnc_centrality(G)
             edge_labels=None
      ...
      viz(G, max_neighborhood_whole, edge_labels)
      return max_neighborhood_whole
