...
class LClustering:
    ...
    def local_clustering_centrality(self, feature_option):
      local_clustering_centrality = {}
      ...
      if 'edge_weight' not in df.columns:
             ...
             if G.edges():  # Check if the graph has any edges
              local_clustering_centrality = nx.clustering(G)
              edge_labels=None
      ...
      viz(G, local_clustering_centrality, edge_labels)
      return local_clustering_centrality
    

       
    def local_clustering_whole(self, feature_option):
      ...
      if 'edge_weight' not in df.columns:
        ...
        if G.edges():  # Check if the graph has any edges
             local_clustering_whole = nx.clustering(G)
             edge_labels=None
      ...
      viz(G, local_clustering_whole, edge_labels)
      return local_clustering_whole
