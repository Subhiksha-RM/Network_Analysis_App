...
class Laplacian:
    ...
    def laplacian_centrality(self, feature_option):
      ...
      viz(G, laplacian_centrality, edge_labels)
      return laplacian_centrality
    

       
    def laplacian_whole(self, feature_option):
      ...
      if 'edge_weight' not in df.columns:
        ...
        if G.edges():  # Check if the graph has any edges
             laplacian_whole = nx.laplacian_centrality(G)
             edge_labels=None
      ...
      viz(G, laplacian_whole, edge_labels)
      return laplacian_whole
