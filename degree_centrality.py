...
class Degree:
    ...
    def degree_centrality(self, feature_option):
      degree_centrality = {}
      ...
      viz(G, degree_centrality, edge_labels)
      return degree_centrality
    

       
    def degree_whole(self, feature_option):
      ...
      if 'edge_weight' not in df.columns:
        ...
        if G.edges():  # Check if the graph has any edges
             degree_whole = nx.degree_centrality(G)
             edge_labels=None
      ...
      viz(G, degree_whole, edge_labels)
      return degree_whole
