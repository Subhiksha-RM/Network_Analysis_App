...
class Closeness:
    ...
    def closeness_centrality(self, feature_option):
      ...
      viz(G, closeness_centrality, edge_labels)
      return closeness_centrality
    

       
    def closeness_whole(self, feature_option):
      ...
      if 'edge_weight' not in df.columns:
        ...
        if G.edges():  # Check if the graph has any edges
             closeness_whole = nx.closeness_centrality(G)
             edge_labels=None
      ...
      viz(G, closeness_whole, edge_labels)
      return closeness_whole
