...
class Eigenvector:
    ...
    def eigenvector_centrality(self, feature_option):
      ...
      viz(G, eigenvector_centrality, edge_labels)
      return eigenvector_centrality
    

       
    def eigenvector_whole(self, feature_option):
      ...
      viz(G, eigenvector_whole, edge_labels)
      return eigenvector_whole
