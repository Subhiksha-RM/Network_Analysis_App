...
class Load:
    ...
    def load_centrality(self, feature_option):
      load_centrality = {}
      ...
      viz(G, load_centrality, edge_labels)
      return load_centrality
    

       
    def load_whole(self, feature_option):
      ...
      if 'edge_weight' not in df.columns:
        ...
        if G.edges():  # Check if the graph has any edges
             load_whole = nx.load_centrality(G)
             edge_labels=None
