...
class Percolation:
    ...
    def percolation_centrality(self, feature_option):
      ...
      viz(G, percolation_centrality, edge_labels)
      return percolation_centrality
    

       
    def percolation_whole(self, feature_option):
      ...
      if 'edge_weight' not in df.columns:
        ...
        if G.edges():  # Check if the graph has any edges
             percolation_whole = nx.percolation_centrality(G)
             edge_labels=None
      ...
      viz(G, percolation_whole, edge_labels)
      return percolation_whole
